...
Blog
Help
@marcioaugusto marcioaugusto
 
 Watch 1
  Star 0
 Fork 0ZeniteSolar/ObC-lls
 branch: master  ObC-lls/main.ino
@joaoantoniocardosojoaoantoniocardoso on Apr 20 new file: main.ino
1 contributor
RawBlameHistory    220 lines (191 sloc)  6.217 kB
*/
// Includes.
#include <Thread.h>
...
byte sensor = 0xA0;                                     // variable used in comunication
...
void BluetoothSend(float value,byte sensor){
	byte * b = (byte *) &value;
